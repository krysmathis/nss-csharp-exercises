    ...
    class Program
    {
        static void Main(string[] args)
        {
            Bug la = new Bug(
                "Lew", 
                "Japanese Beetle", 
                new List<string>(){"Seagull"},
                new List<string>(){"Flowers"});

            Console.WriteLine(la.FormalName);
            Console.WriteLine(la.PreyList);
            Console.WriteLine(la.PredatorList);
            Console.WriteLine(la.Eat("Flowers"));
